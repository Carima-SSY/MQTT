...
def init_storage(mqtt_client, device_type, device_id, sensor_status, device_status, print_data, print_recipe, device_alarm):
...
if __name__ == "__main__":
    ...
    init_storage(mqtt_client=mqtt_client, device_type=DEV_TYPE, device_id=DEV_ID, sensor_status=sensor_status, device_status=device_status, print_data=print_data, print_recipe=print_recipe, device_alarm=device_alarm)
